        ...
        var lang = 'ko',
            html = {
                ...
                'form': '<div class="select_sns clearfx">' +
                    ...
                    //'       <a href="#none" class="mg" id="layer_social_display">' + commentLanguage[lang].socialComment + '</a>' + //선거댓글
                    ...
                    //'               <dd>' + commentLanguage[lang].layerSocialComment + '<span class="login_area"><a href="#" target="_self" id="joins_register">회원가입</a><a href="https://my.joins.com/login/" target="_self">로그인</a></span></dd>' + //선거댓글
                    '               <dd class="content">' + commentLanguage[lang].layerSocialComment + '</dd>' +
                    '           </dl>' +
                    '           <a class="btn_close" style="cursor:pointer;" onclick="$(\'.layer_social_comment\').hide();"><i class="icon_close">닫기</i></a>' +
                    '       </div>' +
                    '   </div>' +
                    '</div>' +
